...
## Prereqs (same Environment as the spike)

The Environment image needs **Node ≥20 + uv** (the spike's Dockerfile layers). Nothing else — the
gateway and OpenCode are NOT needed for this check (OpenCode starts lazily on the first *build*).
